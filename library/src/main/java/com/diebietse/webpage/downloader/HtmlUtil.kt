...
internal object HtmlUtil {
    ...
    internal data class DownloadInfo(val url: String, val filename: String)

    internal data class ParsedCss(
        val newCss: String,
        val filesToDownload: Set<DownloadInfo>,
        val cssToDownload: Set<DownloadInfo>
    )

    internal data class CssAndLinks(val css: String, val links: Set<DownloadInfo>)

    internal fun findAndUpdateSrc(document: Document, cssQuery: String): Set<DownloadInfo> {
    ...
    internal fun parseCssForUrlAndImport(cssToParse: String, baseUrl: String): ParsedCss {
        val filesToDownload = mutableSetOf<DownloadInfo>()
    ...
    internal fun parseCssForUrl(cssToParse: String, baseUrl: String): CssAndLinks {
